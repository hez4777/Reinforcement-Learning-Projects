...
from pa2.finite_difference_method import *
...
def test_compute_policy():
    lqr_controller = LQRController(None)
    ...
    Kout, kout = lqr_controller.compute_policy(A, B, m, C, D, E, f, g, h)
...
def test_compute_Q_params():
    ...
    for seed, data in all_data.items():
        ...
        C, D, E, f, g, h = lqr_controller.compute_Q_params(A, B, Q, R, M, q, r, m, b, P, y, p)
...
def test_compute_V_params():
    ...
    for seed, data in all_data.items():
        ...
        P, y, p = lqr_controller.compute_V_params(A, B, m, C, D, E, f, g, h, K, k)
...
if __name__ == "__main__":
    ...
    print("Make sure to test your policy by running `python cartpole.py --env LQR` (hint: the cart pole should stay up if it's correct)")